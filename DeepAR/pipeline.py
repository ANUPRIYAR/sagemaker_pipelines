...
# custom_image_uri = '361625399431.dkr.ecr.eu-west-1.amazonaws.com/sagemaker-deepar-forecast'
base_dir = f"s3://{s3_bucket}/{s3_prefix}"
input_path = f"s3://{s3_bucket}/{s3_prefix}/{input_prefix}"  #added for QA env
...
def get_pipeline(
        ...
        role=None,
        default_bucket=None,
        model_package_group_name="OutOfStockPackageGroup",
        pipeline_name="OutOfStockPipeline",
        base_job_prefix="OutOfStock",
