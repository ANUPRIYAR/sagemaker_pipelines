...
target_schema = {
    "Attributes": [
        ...
        {"AttributeName": "has_cam", "AttributeType": "string"},
    ]
}
...
def check_training_status(forecast, forecast_arn_predictor):
    ...
    """
    for i in range(300):
        data_import_status = forecast.describe_auto_predictor(PredictorArn=forecast_arn_predictor)[
            "Status"
        ]
...
if __name__ == "__main__":
    ...
    predictor_name = dataset_group_name + "_" + "predictor"
